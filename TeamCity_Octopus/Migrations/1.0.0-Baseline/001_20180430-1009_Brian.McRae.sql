-- <Migration ID="f41e979c-d18c-408c-9f09-d04ea9de72d7" />
GO
...
GO
PRINT N'Creating [dbo].[GetContactType]'
GO
...
GO
PRINT N'Creating [dbo].[GetCountryRegion]'
GO
--SET QUOTED_IDENTIFIER ON|OFF
--SET ANSI_NULLS ON|OFF
--GO
...
GO
PRINT N'Creating [dbo].[GetPhoneNumberType]'
GO
--SET QUOTED_IDENTIFIER ON|OFF
--SET ANSI_NULLS ON|OFF
--GO
...
FROM [Sales].[Store] s;
GO
PRINT N'Creating [Person].[GetContactTypeData]'
GO
...
END;
GO
PRINT N'Creating [Person].[DMSSTAT_RSTATS]'
GO
...
GO
PRINT N'Creating index [IX_DMSSTAT_RSTATS] on [Person].[DMSSTAT_RSTATS]'
GO
CREATE NONCLUSTERED INDEX [IX_DMSSTAT_RSTATS] ON [Person].[DMSSTAT_RSTATS] ([runid], [ruleid])
GO
PRINT N'Creating [Person].[DMSSTAT_TSTATS]'
GO
...
GO
PRINT N'Creating index [IX_DMSSTAT_TSTATS_A] on [Person].[DMSSTAT_TSTATS]'
GO
